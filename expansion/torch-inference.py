...
# LOAD DATA
    ...
    train_dataset, train_dataloader = get_dataset(config, tokenizer, interface="torch", accelerator=accelerator, tokenize_the_captions=False)
...
# NOISE SCHEDULAR
    ...
    for batch in train_dataloader:
        if accelerator.is_main_process: 
            ...
            image_grid = make_image_grid(images, rows=6,cols=50)
