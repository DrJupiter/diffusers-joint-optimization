...
def get_dataset(config: Config, tokenizer, interface: str = "torch", accelerator = None, tokenize_the_captions=True):
...
# PREPROCESS THE DATASET
    ...
    def preprocess_train(examples):
        ...
        examples["input_ids"] = tokenize_captions(examples) if tokenize_the_captions else examples[caption_column]
