...
@dataclass
class TuneSdeOutput(BaseOutput):
    prev_sample : torch.FloatTensor

class TuneScheduler(SchedulerMixin, ConfigMixin):
    """
    Module for finetunning Drift and diffusion with model
    """

    order = 1

    # TODO(Klaus): Make this configuarable with custom SDE library
